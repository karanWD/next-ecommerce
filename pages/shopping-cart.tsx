                        ...
                        <div className="w-full">
                            {cart.products.length === 0 ? (
                                ...
                                <>
                                                ...
                                                <div className="flex flex-col gap-1 border-b-2 border-gray200 py-4"
                                                    ...
                                                    <div className='flex justify-between items-start gap-2'>
                                                        ...
                                                        <div className="flex flex-col flex-1">
                                                            <Link
                                                                href={"/products/" + item.slug}><a>{item.title}</a></Link>
                                                            <div className="w-full flex-wrap flex flex-col ">
                                                                ...
                                                                </div>
                                                                {
                                                                    user?.showWage &&
                                                                    <div className="flex w-full text-right">
                                                                        <div className="text-gray-500 text-sm"> اجرت:
                                                                        </div>
                                                                        <div
                                                                            className="text-sm mx-2">{item.wage + " " + t("percent")}</div>
                                                                    </div>
                                                                }
                                    ...
                                    <div
                                        className="mt-4 bg-white fixed bottom-0 left-0 right-0 px-4 py-3 border-t border-gray-300">
                                        <Button size="lg" value={"ثبت سفارش"} onClick={() => setSubmit(true)}
                                                extraClass={"w-full "}/>
                                    </div>
                                        ...
                                        <div>
                                            <div className=" p-4 bg-gray-200 rounded-lg">
                                                ...
                                                </div>
                                                {
                                                    user?.showWage &&
                                                    <div
                                                        className="flex justify-between border-t border-gray-400 mt-2 pt-2">
                                            ...
                                            <div className="mt-8 text-right">
                                                ...
                                                <div className="mt-12 flex ">
                                                    <div className="text-center flex-1 py-3"
                                                         onClick={() => setSubmit(false)}>بازگشت
                                                    </div>
