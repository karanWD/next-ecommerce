  ...
  return (
      <>
        <div className="relative">
          <button type="button" onClick={openModal} aria-label="Cart" className="relative">
            <BagIcon extraClass="h-8 w-8 sm:h-6 sm:w-6"/>
            {
                cart?.products?.length>0 &&
                <div className="bg-gray500 text-white rounded-full text-xs px-2 py-0.5 absolute -bottom-1 -right-1  ">
